...
import { Terminal, FileText, Calendar, Folder, Download, Github, Zap, Shield, Globe } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <header className="border-b bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm sticky top-0 z-40 border-slate-200 dark:border-slate-700">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <a href="/" className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">creanote</h1>
          </a>
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="https://github.com/elitalpa/creanote" target="_blank" rel="noopener noreferrer">
              <Button
                variant="outline"
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          <Badge variant="secondary" className="mb-4 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300">
            Note Management Tool
          </Badge>
          <h2 className="text-5xl md:text-6xl font-bold text-slate-900 dark:text-slate-100 mb-6 leading-tight">
            Easily create
            <span className="text-slate-600 dark:text-slate-400"> organized notes</span>
          </h2>
          <p className="text-xl text-slate-600 dark:text-slate-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            A powerful CLI tool that helps you create and manage your notes in markdown format. Simple, portable, and
            designed for long-term access without vendor lock-in.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="https://github.com/elitalpa/creanote#readme" target="_blank" rel="noopener noreferrer">
              <Button
                variant="outline"
                size="lg"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-slate-200 dark:border-slate-700 hover:shadow-lg dark:hover:shadow-slate-900/20 transition-shadow bg-white dark:bg-slate-800">
              <CardHeader>
                ...
                <CardTitle className="text-slate-900 dark:text-slate-100">Markdown Format</CardTitle>
            ...
            <Card className="border-slate-200 dark:border-slate-700 hover:shadow-lg dark:hover:shadow-slate-900/20 transition-shadow bg-white dark:bg-slate-800">
              <CardHeader>
                ...
                <CardTitle className="text-slate-900 dark:text-slate-100">Daily Notes</CardTitle>
                <CardDescription className="dark:text-slate-400">
            ...
            <Card className="border-slate-200 dark:border-slate-700 hover:shadow-lg dark:hover:shadow-slate-900/20 transition-shadow bg-white dark:bg-slate-800">
              <CardHeader>
                ...
                <CardTitle className="text-slate-900 dark:text-slate-100">Smart Organization</CardTitle>
                <CardDescription className="dark:text-slate-400">
            ...
            <Card className="border-slate-200 dark:border-slate-700 hover:shadow-lg dark:hover:shadow-slate-900/20 transition-shadow bg-white dark:bg-slate-800">
              <CardHeader>
                ...
                <CardTitle className="text-slate-900 dark:text-slate-100">Quick Setup</CardTitle>
                <CardDescription className="dark:text-slate-400">
            ...
            <Card className="border-slate-200 dark:border-slate-700 hover:shadow-lg dark:hover:shadow-slate-900/20 transition-shadow bg-white dark:bg-slate-800">
              <CardHeader>
                ...
                <CardTitle className="text-slate-900 dark:text-slate-100">No Lock-in</CardTitle>
                <CardDescription className="dark:text-slate-400">
            ...
            <Card className="border-slate-200 dark:border-slate-700 hover:shadow-lg dark:hover:shadow-slate-900/20 transition-shadow bg-white dark:bg-slate-800">
              <CardHeader>
                ...
                <CardTitle className="text-slate-900 dark:text-slate-100">Cross-Platform</CardTitle>
                <CardDescription className="dark:text-slate-400">
      ...
      <section id="installation" className="py-20 px-4 bg-slate-50 dark:bg-slate-800">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-slate-100 mb-4">
              Get Started in Seconds
            </h3>
            <p className="text-xl text-slate-600 dark:text-slate-400">Choose your preferred installation method</p>
          </div>
      ...
      <section id="usage" className="py-20 px-4 bg-white dark:bg-slate-900">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-400">Three simple commands to manage all your notes</p>
          </div>
      ...
      <section className="py-20 px-4 bg-slate-900 dark:bg-slate-950 text-white">
        <div className="container mx-auto text-center max-w-3xl">
          <h3 className="text-3xl md:text-4xl font-bold mb-6 text-white">Start Organizing Your Notes Today</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="#installation">
              <Button size="lg" variant="secondary" className="bg-white text-slate-900 hover:bg-slate-100 px-8 py-3">
                <Terminal className="h-5 w-5 mr-2" />
                Try with npx
              </Button>
            </Link>
      ...
      <footer className="py-12 px-4 bg-slate-50 dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700">
        <div className="container mx-auto text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-lg font-semibold text-slate-900 dark:text-slate-100">creanote</span>
          </div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-500">Licensed under the MIT license</p>
        </div>
      </footer>
